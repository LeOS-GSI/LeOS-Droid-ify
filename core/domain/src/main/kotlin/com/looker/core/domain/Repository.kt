...
data class Repository(
    ...
    companion object {
        ...
        val defaultRepositories = listOf(
            ...
            defaultRepository(
                address = "http://62.178.96.192:3000/JoJo/apps/raw/branch/master/fdroid/repo",
                name = "LeOS ungooled Apps",
                description = "The respository includes goolge and trackerfree FOSS apps ",
                enabled = true,
                fingerprint = "020480A56FD52E6358FAFEFACE2261FFCFD5C6962B245B0244C9257EEFBDFF5C"
            ),        
            defaultRepository(
                address = "https://gitlab.com/harvey186/apps/-/raw/master/fdroid/repo",
                name = "Alternativ Server for LeOS ungooled Apps",
                description = "Alternativ Server for LeOS ungooled Apps",
                enabled = false,
                fingerprint = "020480A56FD52E6358FAFEFACE2261FFCFD5C6962B245B0244C9257EEFBDFF5C"
            ),        
